...
export function MobileModuleStrip({ onNavigate }: { onNavigate: (id: string) => void }) {
  ...
  return (
    <nav
      ...
      className="sticky top-[73px] z-40 flex gap-1 overflow-x-auto border-b border-hair bg-base/95 px-4 py-2 backdrop-blur-sm lg:hidden"
    >
        ...
        return (
          <button
            ...
            className={cn(
              ...
              isActive ? "border-accent bg-accent text-base" : "border-hair text-mute"
            )}
          >
